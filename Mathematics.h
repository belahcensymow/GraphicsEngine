...
std::array<float, 16> rotate (const std::array<float, 3>& rotation);
...
std::array<float, 16> translate (const std::array<float, 3>& translation);
...
std::array<float, 3> Normalize(const std::array<float, 3>& array3);
float dotProduct3(const std::array<float, 3>& array1, const std::array<float, 3>& array2);
std::array<float, 3> crossProduct3(const std::array<float, 3>& leftArray, const std::array<float, 3>& rightArray);

template<typename T, std::size_t N> std::array<T,N> operator+(const std::array<T,N>& leftArray, const std::array<T,N>& rightArray)
{
...
template<typename T, std::size_t N> std::array<T,N> operator+(const std::array<T,N>& leftArray, T scalar)
{
    std::array<T, N> result;
    for (std::size_t i = 0; i < N; i++) result[i] = leftArray[i] + scalar;
    return result;
}
template<typename T, std::size_t N> std::array<T,N> operator-(const std::array<T,N>& leftArray, T scalar)
{
...
template<typename T, std::size_t N> void operator+=(std::array<T,N>& leftArray, const std::array<T,N>& rightArray) { for (std::size_t i = 0; i < N; i++) leftArray[i] += rightArray[i]; }
template<typename T, std::size_t N> void operator-=(std::array<T,N>& leftArray, const std::array<T,N>& rightArray) { for (std::size_t i = 0; i < N; i++) leftArray[i] -= rightArray[i]; }
template<typename T, std::size_t N> void operator*=(std::array<T,N>& leftArray, const std::array<T,N>& rightArray) { for (std::size_t i = 0; i < N; i++) leftArray[i] *= rightArray[i]; }
template<typename T, std::size_t N> void operator/=(std::array<T,N>& leftArray, const std::array<T,N>& rightArray) { for (std::size_t i = 0; i < N; i++) leftArray[i] /= rightArray[i]; }

template<typename T, std::size_t N> void operator+=(std::array<T,N>& leftArray, const T& scalar) { for (std::size_t i = 0; i < N; i++) leftArray[i] += scalar; }
template<typename T, std::size_t N> void operator-=(std::array<T,N>& leftArray, const T& scalar) { for (std::size_t i = 0; i < N; i++) leftArray[i] -= scalar; }
template<typename T, std::size_t N> void operator*=(std::array<T,N>& leftArray, const T& scalar) { for (std::size_t i = 0; i < N; i++) leftArray[i] *= scalar; }
template<typename T, std::size_t N> void operator/=(std::array<T,N>& leftArray, const T& scalar) { for (std::size_t i = 0; i < N; i++) leftArray[i] /= scalar; }
